...
import { motion, Variants, currentColor } from 'framer-motion';

const helloStart: currentColor = "rgb(90, 10, 15)";
const hello: currentColor = "rgb(100, 150, 175)";
...
const Home: NextPage = () => {
  ...
  const h1: Variants = {
    hidden: {opacity: 0},
    visible: {opacity: 0.9, color: [helloStart, hello], textShadow: `1vh 1vh 1vh ${helloShadow}`},
  }
  return (
    <div>
